...
| `tests/test_summarize_v3_promotion_readiness.py` | v3 formal promotion readiness 总审计测试，覆盖 v3 practical archive-live guard brief contract checks 与 SCP guarded bridge stability artifact contract |
