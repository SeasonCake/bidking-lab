...
| `tests/test_summarize_v3_promotion_workbench.py` | v3 lane-level promotion workbench 测试，覆盖 stop-loss lane、archive quality watch、shadow sampler contract 边界与 support-aware prototype/guard-trial/value-source-profile/value-map-profile-details blocker |
