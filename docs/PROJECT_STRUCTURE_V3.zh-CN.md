...
| `scripts/summarize_v3_scp_count_value_bridge_holdout.py` | v3 settlement count-prior count->cells/value bridge session holdout，验证 bridge floor 对 formal MAE/p90/over-rate 的影响 |
...
| `tests/test_summarize_v3_scp_count_value_bridge_holdout.py` | v3 settlement count-prior count->cells/value bridge holdout 测试 |
