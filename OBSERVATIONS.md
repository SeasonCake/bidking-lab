...
- 2026-06-01 新增 Aisha imaging 样本 30 份：
  ...
  - 30/30 有 category target，27/30 有 negative category，合计 `target_total=488`、
    `exclusion_total=823`；仅 1 份出现 `category_target_no_pool_match`：
    `aisha_villa_imagingtest_sample9__5rounds.json` 的 `101:q4:11:1`。
  - 按可见轮次覆盖分层：`early_1_2=7`、`mid_3_4=19`、`full_5=4`；
    其中 23 份可进入中后期稳定校准，7 份短轮样本保留用于早期实时提示与解析验证。
  - 30 份快速评估仍显示 q6 P90 低估：`q6_p90_misses_truth=15`，
    villa 与 shipwreck 都需要后续 residual/shape-category 权重优化。
