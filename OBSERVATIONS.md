...
- 2026-06-01 q6 可规划低估根因继续拆分：
  ...
  - 271 份、`--trials 20` 快速扫中，可规划 q6 低估根因前列为：
    `q6_cells_under=92`、`q6_count_under=90`、`low_q6_value_distribution=56`、
    `mixed_q6_sample_value=44`、`layout_conflict=44`、`below_drop_prior=35`。这说明下一步不能只提高
    q6 出现率；还要处理 q6 count/cells、layout footprint 可信度和剩余空间/件数组合。
