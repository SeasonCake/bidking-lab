...
- 群友导出 `2408:1425860637281329` R5 replay：0 红 → **0/0/0**，参考 **194,680**。
- 群友导出 `data 10` / `2404:1425860638280566` R5 replay：3 红 → **3/3/3**，结算 `final_q6_count=3`；旧逻辑仅下限时会显示 **3/3/4**。
...
- 路径：`dist/BidKingHeroRef-v0.1.8-hotfix-full.zip`（仓库根目录 `bidking-lab/dist/`；构建脚本也会从 `external_references/ahmad_live_reference_lab/dist/` 同步一份）
