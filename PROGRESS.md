...
- q6 评估口径已拆成 raw 结算与可规划红货：批评估新增 `final_q6_decision_value`、`final_q6_trimmed_tail_value`、`q6_plannable_p90_misses_truth`、`q6_plannable_value_p90_coverage` 和 `q6_plannable_calibration_priority`。271 份唯一 JSON、`--trials 40` 快速扫下，raw q6 覆盖约 `49.3%`，可规划 q6 覆盖约 `51.8%`，尾部 q6 事件 13 份、裁尾中位约 `123.7万`。结论是极端尾部不再作为准确率主线，但 Aisha shipwreck 的可规划 q6 residual 仍需继续优化。
