...
| 状态 | 项 | 说明 |
|------|-----|------|
| **▶ 下一项（C-32）** | **P0-B**：`adaptive_filter` fallback 保留 `huge_cells_override` | 改 `posterior.py` 硬约束重建；1 条单测；样本不足 fallback 时与「★具体巨物」一致 |
...
| P0-B | fallback 保留 `huge_cells_override` | ▶ **下一项 C-32** |
