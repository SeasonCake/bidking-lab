...
- `pytest -q`：**435 passed**
- `.\scripts\test_smoke.ps1`：**422 passed / 13 deselected**（跳过真实 OCR 图片回归）
...
cd c:\xiangmuyunxing\biancheng\2026\bidking-lab
pip install -e .
.\scripts\test_smoke.ps1  # 日常 smoke，应该 422 passed / 13 deselected
pytest -q                 # 全量，应该 435 passed
