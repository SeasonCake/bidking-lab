...
- `pytest -q`：**431 passed**
- `.\scripts\test_smoke.ps1`：**418 passed / 13 deselected**（跳过真实 OCR 图片回归）
...
cd c:\xiangmuyunxing\biancheng\2026\bidking-lab
pip install -e .
.\scripts\test_smoke.ps1  # 日常 smoke，应该 418 passed / 13 deselected
pytest -q                 # 全量，应该 431 passed
