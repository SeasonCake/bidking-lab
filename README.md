...
[![Tests](https://img.shields.io/badge/tests-436_passing-2ea043)](./tests)
...
# 2) Run the full test suite (436 tests, includes real OCR image regressions)
pytest -q
...
- ✅ Screen capture + OCR prefill (C-35~39) · 7 notebooks · **436** unit tests · **52** TROUBLESHOOTING entries
